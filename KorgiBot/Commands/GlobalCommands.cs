...
namespace KorgiBot.Commands
{
	...
	public class GlobalCommands : ApplicationCommandModule, IGlobalCommands
    {
		...
		public Task StartRegistration(InteractionContext context)
        {
			return _serviceManager.GetServerService(context.Guild.Id).ServerGlobalCommands.StartRegistration(context);
        }
		...
		public Task RemoveRegistration(InteractionContext context, 
		...
		{
			return _serviceManager.GetServerService(context.Guild.Id).ServerGlobalCommands.RemoveRegistration(context, threadId);
		}
		...
		public Task EditRegistration(InteractionContext context,
			[Option("ThreadId", "Id ветки.", true)][Autocomplete(typeof(RaidsAutocompleteProvider))]
			[DescriptionLocalization(Localization.AmericanEnglish, "Thread id.")]
			[DescriptionLocalization(Localization.BritishEnglish, "Thread id.")] string threadId)
		{
			return _serviceManager.GetServerService(context.Guild.Id).ServerGlobalCommands.EditRegistration(context, threadId);
		}
		...
		public Task CheckOnPresence(InteractionContext context,
			[Option("ThreadId", "Id ветки.", true)][Autocomplete(typeof(RaidsAutocompleteProvider))]
			[DescriptionLocalization(Localization.AmericanEnglish, "Thread id.")]
			[DescriptionLocalization(Localization.BritishEnglish, "Thread id.")] string threadId)
		{
			return _serviceManager.GetServerService(context.Guild.Id).ServerGlobalCommands.CheckOnPresence(context, threadId);
		}
		...
		public Task CheckVoicesOnRegistration(InteractionContext context,
			[Option("ThreadId", "Id ветки.", true)][Autocomplete(typeof(RaidsAutocompleteProvider))]
			[DescriptionLocalization(Localization.AmericanEnglish, "Thread id.")]
			[DescriptionLocalization(Localization.BritishEnglish, "Thread id.")] string threadId)
		{
			return _serviceManager.GetServerService(context.Guild.Id).ServerGlobalCommands.CheckVoicesOnRegistration(context, threadId);
		}
		...
		public Task CheckVoicesOnRegAndMove(InteractionContext context,
			[Option("ThreadId", "Id ветки.", true)][Autocomplete(typeof(RaidsAutocompleteProvider))]
			[DescriptionLocalization(Localization.AmericanEnglish, "Thread id.")]
			[DescriptionLocalization(Localization.BritishEnglish, "Thread id.")] string threadId,
		...
		{
			return _serviceManager.GetServerService(context.Guild.Id).ServerGlobalCommands.CheckVoicesOnRegAndMove(context, threadId, all);
		}
		...
		public Task NotifyRaidStarts(InteractionContext context,
			[Option("ThreadId", "Id ветки.", true)][Autocomplete(typeof(RaidsAutocompleteProvider))]
			[DescriptionLocalization(Localization.AmericanEnglish, "Thread id.")]
			[DescriptionLocalization(Localization.BritishEnglish, "Thread id.")] string threadId)
		{
			return _serviceManager.GetServerService(context.Guild.Id).ServerGlobalCommands.NotifyRaidStarts(context, threadId);
		}
		...
		public Task SendMessageToAll(InteractionContext context,
		...
		{
			return _serviceManager.GetServerService(context.Guild.Id).ServerGlobalCommands.SendMessageToAll(context, recipientsRole, content);
		}
	}
}
